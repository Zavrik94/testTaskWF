...
/**
 * WalletsTypeSearch represents the model behind the search form of `common\models\WalletsType`.
 */
class WalletsTypeSearch extends WalletsType
{
    /**
     * {@inheritdoc}
     */
